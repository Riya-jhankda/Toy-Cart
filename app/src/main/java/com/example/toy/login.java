...
public class login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sharedPreferences = getSharedPreferences("signInActivity", MODE_PRIVATE) ;
        ...
        {
            Intent intent = new Intent(com.example.toy.login.this, MainActivity.class);
